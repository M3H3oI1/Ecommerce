...
<head>
    ...
    <!-- This page CSS -->
    <link rel="stylesheet"href="{{ asset('/')}}admin/assets/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet"/>
    <link rel="stylesheet"href="{{ asset('/')}}admin/assets/node_modules/datatables.net-bs4/css/responsive.dataTables.min.css" rel="stylesheet"/>
...
<body class="skin-blue fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © {{ date('Y-m-d') }} Design & Developed by SoftParkITWebBatchOne
                ...
                $(document).on('change','#categoryId',function(){
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            subCategoryId.empty();
                            var option ='';
                         option += '<option value="" disable selected> -- Select Sub Category -- </option>';
                            $.each(response, function (key, value) {
                        option += '<option value="'+value.id+'" disable selected> '+value.name+' </option>';
                            });
